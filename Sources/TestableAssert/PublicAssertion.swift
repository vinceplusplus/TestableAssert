...
public func expectFailureByAssert(_ closure: @escaping () -> Void,
...
public func expectFailureByAssertionFailure(_ closure: @escaping () -> Void,
                                            _ expectedMessage: String? = nil,
                                            file: StaticString = #file,
                                            line: UInt = #line) {
...
public func expectFailureByPrecondition(_ closure: @escaping () -> Void,
                                        _ expectedMessage: String? = nil,
                                        file: StaticString = #file,
                                        line: UInt = #line) {
...
public func expectFailureByPreconditionFailure(_ closure: @escaping () -> Void,
                                               _ expectedMessage: String? = nil,
                                               file: StaticString = #file,
                                               line: UInt = #line) {
...
public func expectFatalError(_ closure: @escaping () -> Void,
                             _ expectedMessage: String? = nil,
                             file: StaticString = #file,
                             line: UInt = #line) {
...
public func expectFailedAssertion(_ closure: @escaping () -> Void,
                                  _ expectedMessage: String? = nil,
                                  file: StaticString = #file,
                                  line: UInt = #line) {
...
public func expectFailedPrecondition(_ closure: @escaping () -> Void,
                                     _ expectedMessage: String? = nil,
                                     file: StaticString = #file,
                                     line: UInt = #line) {
...
public func expectAnyFailure(_ closure: @escaping () -> Void,
                             _ expectedMessage: String? = nil,
                             file: StaticString = #file,
                             line: UInt = #line) {
  expectFailure(assertFuncs: [.assert,
